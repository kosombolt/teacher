    ...
    <button
      className={cn(
        'inline-flex items-center justify-center rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background',
        {
          ...
          'border text-gray-700 hover:bg-gray-50 hover:shadow-medium dark:text-neutral-300 dark:hover:bg-neutral-700 border-gray-300 hover:border-gray-400 dark:border-neutral-600 dark:hover:border-neutral-500': variant === 'outline',
          'text-gray-700 hover:bg-gray-100 hover:shadow-soft dark:text-neutral-300 dark:hover:bg-neutral-700': variant === 'ghost',
        },
        {
