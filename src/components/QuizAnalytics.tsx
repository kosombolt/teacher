      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">Quiz Analytics & Performance</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-slate-100">{quiz.attempts}</div>
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-slate-100">{quiz.avgScore}%</div>
              <div className="flex items-center gap-1 text-xs">
                <TrendingUp className="h-3 w-3 text-green-400" />
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-slate-100">24m</div>
              <div className="text-xs text-slate-400">
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="bg-slate-800 border-slate-700">
                <CardHeader>
                  <CardTitle className="text-slate-100">Score Distribution</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4">
                    {scoreDistribution.map((item, index) => (
                      <div key={index} className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate-300 ml-auto">{item.count}</span>
                      </div>
                    ))}
                  </div>
                </CardContent>
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <CardTitle className="text-slate-100">Quiz Details</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <h4 className="font-medium text-slate-100 mb-2">Basic Information</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-slate-400">Subject:</span>
                        <span className="text-slate-300">{quiz.subject}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-400">Topic:</span>
                        <span className="text-slate-300">{quiz.topic}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-100 mb-2">Quiz Settings</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-slate-300">{quiz.timeLimit} minutes</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-400">Total Points:</span>
                        <span className="text-slate-300">{quiz.totalPoints}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div>
                    <h4 className="font-medium text-slate-100 mb-2">Performance Summary</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        <span className="text-slate-400">Retake Rate:</span>
          ...
          <TabsContent value="questions" className="space-y-6">
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <CardTitle className="text-slate-100">Question Performance Analysis</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  {questionAnalysis.map((question, index) => (
                    <div key={index} className="p-4 bg-slate-700/50 rounded-lg">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="font-medium text-slate-100">{question.question}</h4>
                        <div className="flex items-center gap-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm mt-3">
                          ...
                          <div>
                            ...
                            <p className="text-slate-100">{question.avgTime}s</p>
                          </div>
                          <div>
                            <p className="text-slate-400">Status</p>
                            <p className={question.correct >= 70 ? 'text-green-400' : 'text-red-400'}>
          ...
          <TabsContent value="students" className="space-y-6">
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <CardTitle className="text-slate-100">Individual Student Performance</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  <table className="w-full">
                    <thead className="border-b border-slate-700">
                      <tr className="text-left">
                        <th className="p-3 text-sm font-medium text-slate-400">Student</th>
                        <th className="p-3 text-sm font-medium text-slate-400">Score</th>
                        <th className="p-3 text-sm font-medium text-slate-400">Time Taken</th>
                        <th className="p-3 text-sm font-medium text-slate-400">Attempts</th>
                        <th className="p-3 text-sm font-medium text-slate-400">Status</th>
                        <th className="p-3 text-sm font-medium text-slate-400">Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      {studentPerformance.map((student, index) => (
                        <tr key={index} className="border-b border-slate-700 hover:bg-slate-700/50">
                          ...
                          <td className="p-3">
                            <div className="flex items-center gap-2">
                              <span className={cn(
                                ...
                                student.score > 0 ? "text-red-400" : "text-slate-400"
                              )}>
                          ...
                          <td className="p-3 text-slate-300">{student.attempts}</td>
                          <td className="p-3">
                            <Badge className={
                              student.status === 'completed' ? 'bg-green-500/20 text-green-400' :
                              student.status === 'in_progress' ? 'bg-yellow-500/20 text-yellow-400' :
                              'bg-slate-500/20 text-slate-400'
                            }>
          ...
          <TabsContent value="insights" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-slate-800 border-slate-700">
                <CardHeader>
                  <CardTitle className="text-slate-100">Key Insights</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="font-medium text-green-400">Strong Performance</span>
                      </div>
                    ...
                    <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="font-medium text-blue-400">Time Management</span>
                      </div>
                      <p className="text-sm text-slate-300">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-100">Review Question 3</p>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-violet-500 rounded-full mt-2"></div>
                      <div>
                        <p className="font-medium text-slate-100">Add Visual Aids</p>
                        <p className="text-sm text-slate-400">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-violet-500 rounded-full mt-2"></div>
                      <div>
                        <p className="font-medium text-slate-100">Create Practice Quiz</p>
                        <p className="text-sm text-slate-400">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-violet-500 rounded-full mt-2"></div>
                      <div>
                        <p className="font-medium text-slate-100">Follow-up Assessment</p>
                        <p className="text-sm text-slate-400">
